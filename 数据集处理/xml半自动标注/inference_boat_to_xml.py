...
if __name__ == "__main__":
    ...
    weightfile = 'checkpoints/best_Yolov4_epoch445.pth'
    # train_data_path = 'VOCdevkit/VOC2007/ImageSets/Main/test1.txt'
    root_dir = 'examples/origin_left' #图像文件夹路径
    xml_dir = 'examples/labels'
    ...
    width = 608
    height = 608
    conf_thresh = 0.3 # Boxes with confidence more than this value are kept
    nms_thresh = 0.3 # Boxes with iou less than this value are kept
    ...
    for img_name in tqdm(test_data_list):
        ...
        namesfile = 'data/boat.names'
        class_names = load_class_names(namesfile)
        save_path = os.path.join('examples/results/', img_name)
        ...
        writer.save(os.path.join(xml_dir, img_name[:-4]+'.xml'))

        all_box_dict[img_name] = boxes[0]
