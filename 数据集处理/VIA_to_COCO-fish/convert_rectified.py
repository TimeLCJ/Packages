...
if __name__== '__main__':
    ...
    img_path = '../fish_video/datasets_via_json/henze/val/' #改成自己的图片路径
    anno_path = '../fish_video/datasets_via_json/henze/val_via_region_data.json' #自己的标注文件的路径。注意这里不是使用的VIA导出的coco格式文件，而是单纯的json格式文件。
    result_path = '../henze_coco/annotations/instances_val.json' #输出，结果文件
